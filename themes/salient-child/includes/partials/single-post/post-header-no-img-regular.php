            ...
            if ( ( empty( $bg ) && empty( $bg_color ) ) && $fullscreen_header != true && $inherit_and_has_featured_img !== true ) { ?>
                ...
                <div class="row heading-title hentry" data-header-style="<?php echo esc_attr( $blog_header_type ); ?>">
                    ...
                    ?>
                        ...
                        ?>
                        <div id="single-below-header" data-hide-on-mobile="<?php echo esc_attr($using_fixed_salient_social); ?>" style="display: flex; align-items: center;">
                            <?php echo '<span class="meta-author vcard author"><span class="fn">' . esc_html__('Author', 'salient') . ': ' . get_the_author_posts_link() . '</span></span>';
