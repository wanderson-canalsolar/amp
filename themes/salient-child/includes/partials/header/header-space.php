...
$nectar_header_options['page_full_screen_rows'] === 'on' ) { ?>
	...
	<div id="header-space" style="height:174px" <?php echo (esc_html($header_secondary_m_attr)) ? 'data-secondary-header-display="full"' : ''; ?> data-header-mobile-fixed='<?php echo esc_attr( $nectar_header_options['mobile_fixed'] ); ?>'></div> 
