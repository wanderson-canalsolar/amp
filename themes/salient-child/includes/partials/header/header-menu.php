...
<header id="top">
    <div class="container">
        <div id="top1" class="align-items-center" style="align-items: center;">
        ...
        <div class="row">
            ...
            <div class="col mobile" style="margin-top: 7px;">
                ...
                <div style="float: left">
                    ...
                    <div class="col  mobile  search_coluna" style="width: 60%;margin-left: 5%;margin-top: 7px;">
                        <form method="get" action="/">
                            <div class="content" style="display:flex">
                                <input type="text" class="newsletter"  name="s" placeholder="Buscar no Canal Solar" />
                                <button type="submit" class="button btn-xs" style="background-color: #E64F38;
                        ...
                        <div style="margin-top: 18px;" class="slide-out-widget-area-toggle mobile-icon right <?php echo esc_attr( $nectar_header_options['side_widget_class'] ); ?>" data-custom-color="<?php echo esc_attr($nectar_header_options['ocm_menu_btn_color']); ?>" data-icon-animation="simple-transform">
                            <div>

                                <a href="#sidewidgetarea" aria-label="<?php echo esc_attr__('Navigation Menu', 'salient'); ?>" aria-expanded="false" class="<?php echo 'closed' . esc_attr($menu_label_class); ?>">
    ...
    <?php if ( is_active_sidebar( 'header-1' ) and is_front_page()) : ?>
        <div class="row">
            <div id="header1" class="mobile" style="background-color:#EEEEEE;  padding: 2%;">
