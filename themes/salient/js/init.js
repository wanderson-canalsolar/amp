...
/* MUDAR TEXTO MENU NOTICIAS*/
// let titulo_customizado = document.querySelector(".all-filter");
// titulo_customizado.id = "item-menu-todos";
// document.getElementById('item-menu-todos').innerText = 'Todas'; 
