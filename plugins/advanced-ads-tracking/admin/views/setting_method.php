...
<?php if ( $this->plugin->options()['method'] === 'shutdown' ) : ?>
	...
	<p class="description advads-error-message">
		<?php
		/** Translators: 1: opening a-tag for link to documentation 2: closing a-tag */
		printf(esc_html__('This feature will be removed with the next major version of Advanced Ads Tracking. %sRead more about the removal here%s', 'advanced-ads-tracking'), '<a href="https://wpadvancedads.com/manual/deprecated-features/#Scheduled_for_removal" target="_blank">', '</a>');
		?>
	</p>
<?php endif; ?>
