...
<input type="hidden" class="bpmpi_paymentmethod" value="debit">
...
<input type="hidden" class="bpmpi_cardnumber" id="auth_cc" value="" />
<input type="hidden" class="bpmpi_installments" id="auth_par" value="" />
...
<select style="box-shadow: inset 2px 0 0 #0f834d;height:40px;width:100%;background-color: #f2f2f2;border: none;" name="cielo_webservice_debito[validade_mes]" id="validade-cielo-webservice-debito-mes" class="bpmpi_cardexpirationmonth">
...
<select style="box-shadow: inset 2px 0 0 #0f834d;height:40px;width:100%;background-color: #f2f2f2;border: none;" name="cielo_webservice_debito[validade_ano]" id="validade-cielo-webservice-debito-ano" class="bpmpi_cardexpirationyear">
...
<select style="box-shadow: inset 2px 0 0 #0f834d;height:40px;background-color: #f2f2f2;border: none;" name="cielo_webservice_debito[parcela]" id="parcela-cielo-webservice-debito" class="">
<option value="">Selecione uma bandeira...</option>
</select>
</p>

<input type="hidden" id="auth-cielo-webservice" name="cielo_webservice_debito[auth]" value="">
<input type="hidden" id="eci-cielo-webservice" name="cielo_webservice_debito[eci]" value="">
<input type="hidden" id="referenceid-cielo-webservice" name="cielo_webservice_debito[referenceid]" value="">
<input type="hidden" id="version-cielo-webservice" name="cielo_webservice_debito[version]" value="">
<input type="hidden" id="xid-cielo-webservice" name="cielo_webservice_debito[xid]" value="">
<input type="hidden" id="cavv-cielo-webservice" name="cielo_webservice_debito[cavv]" value="">
...
function autenticar_debito(){
	console.log('debito valid');
	//valida
	var nome = jQuery('#nome-cielo-webservice-debito').val();
	if(nome==''){
		jQuery('#nome-cielo-webservice-debito').focus();
		return false;
	}
	var numero = jQuery('#numero-cielo-webservice-debito').val();
	if(numero==''){
		jQuery('#numero-cielo-webservice-debito').focus();
		return false;
	}
	var mes = jQuery('#validade-cielo-webservice-debito-mes').val();
	if(mes==''){
		jQuery('#validade-cielo-webservice-debito-mes').focus();
		return false;
	}
	var ano = jQuery('#validade-cielo-webservice-debito-ano').val();
	if(ano==''){
		jQuery('#validade-cielo-webservice-debito-ano').focus();
	}
	var cvv = jQuery('#cvv-cielo-webservice-debito').val();
	if(cvv==''){
		jQuery('#cvv-cielo-webservice-debito').focus();
		return false;
	}
	var bandeira = jQuery('#bandeira-cielo-webservice-debito').val();
	if(bandeira==''){
		jQuery('#parcela-cielo-webservice-debito').focus();
		return false;
	}
	var par = jQuery('#parcela-cielo-webservice-debito').val();
	if(par==''){
		jQuery('#parcela-cielo-webservice-debito').focus();
		return false;
	}
	//clona
	jQuery('#auth_cc').val(jQuery('input[name="cielo_webservice_debito[numero]"]').val().replace(/\s/g, ""));
	jQuery('#auth_par').val(jQuery('select[name="cielo_webservice_debito[parcela]"]').find(":selected").data('parcela'));
	//auth 
