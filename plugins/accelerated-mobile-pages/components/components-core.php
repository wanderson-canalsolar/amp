...
function amp_loop_template2(){
	global $ampforwpTemplate;
	$post_id = get_queried_object_id();
	$thisTemplate = $ampforwpTemplate;
	do_action('amp_before_loop2',$thisTemplate);
	$thisTemplate->load_parts( array( 'loop2' ) );
	do_action('amp_after_loop2',$thisTemplate);
}

function amp_loop_template3(){
	global $ampforwpTemplate;
	$post_id = get_queried_object_id();
	$thisTemplate = $ampforwpTemplate;
	do_action('amp_before_loop3',$thisTemplate);
	$thisTemplate->load_parts( array( 'loop3' ) );
	do_action('amp_after_loop3',$thisTemplate);
}
// The Content
