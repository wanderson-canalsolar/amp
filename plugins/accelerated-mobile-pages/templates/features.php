		...
		if(!empty($matches) && false == ampforwp_get_setting('ampforwp-amp-convert-to-wp')){
			if(isset($matches[0])){
				...
				for($i=0;$i<count($matches[0]);$i++){
					...
					$fallback_img = "<amp-img data-hero id='id-teste-amp-img-datahero' ".$m_content."<amp-img fallback data-hero id='id-teste-amp-img-fallback'".$m1_content."</amp-img></amp-img>";//$m_content, $m1_content escaped above.
