...
<div class="advads-sub-settings">
	...
	<p class="description"><?php esc_html_e( 'Choose which method to use when cache-busting is set to “auto”.', 'advanced-ads-pro' ); ?></p>
	<label>
	...
	<p id="advads-pro-vc-hash-change-error" class="advads-error-message" style="display:none;"><?php esc_html_e( 'An error occured', 'advanced-ads-pro' ); ?></p>
