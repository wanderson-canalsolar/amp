...
class Advanced_Ads_Pro_Module_Cache_Busting {
    ...
    public function enqueue_scripts() {
        ...
        if ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) {
            ...
            wp_register_script( 'advanced-ads-pro/cache_busting', $uriRelPath . 'inc/base.js', array_merge( $dependencies, array( 'krux/postscribe' ) ), AAP_VERSION, $in_footer );
        } else {
            // minified
            wp_register_script( 'advanced-ads-pro/cache_busting', $uriRelPath . 'inc/base.min.js', $dependencies, AAP_VERSION, $in_footer );
        }
