...
<div class="advads-sub-settings">
	...
	<label>
		...
		<p id="advanced-ads-pro-server-domains-error"
		   class="advads-error-message hidden"><?php esc_html_e( 'Please don’t enter subdirectories.', 'advanced-ads-pro' ); ?></p>
	</label>
	<br/><br/>
	<label>
...
<script>
	...
	jQuery(document).ready(function () {
		jQuery( '#advanced-ads-pro-server-domains' ).change(function () {
