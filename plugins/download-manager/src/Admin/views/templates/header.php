...
$actions = [
    ['link' => "edit.php?post_type=wpdmpro&page=templates&_type=page&task=NewTemplate" . (wpdm_query_var('lockOption') != '' ? '&lockOption=' . wpdm_query_var('lockOption') : ''), "class" => "secondary", "name" => '<i class="fa fa-file"></i> ' . __("Create Page Template", "download-manager")],
    ['link' => "edit.php?post_type=wpdmpro&page=templates&_type=link&task=NewTemplate" . (wpdm_query_var('lockOption') != '' ? '&lockOption=' . wpdm_query_var('lockOption') : ''), "class" => "secondary", "name" => '<i class="fa fa-link"></i> ' . __("Create Link Template", "download-manager")],
    ['link' => "edit.php?post_type=wpdmpro&page=templates&_type=import" . (wpdm_query_var('lockOption') != '' ? '&lockOption=' . wpdm_query_var('lockOption') : ''), "class" => "primary", "name" => '<i class="fa fa-file-import"></i> ' . __("Import Template", "download-manager")]
];
