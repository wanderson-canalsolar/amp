...
function wpfd_avada_search_params(e) {
    ...
    var result          = '[wpfd_search cat_filter="'+ categoryFilter +'" tag_filter="'+ tagFilter +'" display_tag="'+ tagAs +'" create_filter="'+ creationDate +'" update_filter="'+ updateDate +'" file_per_page="'+ perPage +'"]';
