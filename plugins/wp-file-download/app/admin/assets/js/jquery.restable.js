    ...
    Plugin.prototype = {
       ...
       _enableHideCols : function(){
           ...
           if(this.options.selectCol===true){
               colHtml = '<div class="restableMenu restableMenuClosed" id="restableMenu'+instancesCount+'"><a class="restableMenuButton" href="#"><i class="material-icons">filter_list</i></a><i class="material-icons wpfd-flip">arrow_right_alt</i><ul>';
           ...
           $(this.wrapper).find('.restableMenuButton').click(function() {
               if($(this).parents('.restableMenu').hasClass('restableMenuClosed')){
                   ...
                   //$('.wpfd-filter-file').css('right','90px');
               }else{
