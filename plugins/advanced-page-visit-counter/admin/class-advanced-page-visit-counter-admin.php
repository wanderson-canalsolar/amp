...
class Advanced_Visit_Counter_Admin extends Advanced_Visit_Counter_Queries
{
    ...
    public function apvc_dashboard_page()
    {
	    ...
	    <?php 
            $apvcSetPromo = get_transient( "apvcSetPromo" );
            $prem = get_option( "apvc_promo", true );
            
            if ( $apvcSetPromo == 'no' && $prem == 'yes' && !apvc_fs()->is__premium_only() ) {
                ?>
	    <div class="modal fade" id="getPremium" style="top:10%; width: 100%" tabindex="-1" role="dialog" aria-labelledby="getPremium" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 768px;">
              <div class="modal-header text-center">
                <h5 class="modal-title"><?php 
                _e( "Upgrade to premium version now...", "apvc" );
                ?></h5>
              </div>
              <div class="modal-body setCntPreview" style="padding: 10px 25px;">
              	<h4>Enjoy tons of new features...</h4>
              	<ul>
              		<li>Now get info city, states, and countries about visitors.</li>
              		<li>Advanced bots filters</li>
              		<li>Exclude counts by country</li>
              		<li>Exclude counts by users</li>
              		<li>Hide widget based on user roles</li>
              		<li>Hide Widgets/Counter on frontend for specific users</li>
              		<li>Icons for counter widgets</li>
              		<li>Exclude web crawlers</li>
              		<li>Hide all shortcodes by just one settings</li>
              		<li>Icon Positions</li>
              		<li>Advanced Filters</li>
              		<li>Advanced Filters with Charts</li>
              		<li>New improved Charts</li>
              		<li>24x7x365 Quick support</li>
              		<li>30 Days moneyback guarantee. (No questions asked).</li>
              		<li>2 Major updates in a month and improvement and fixes updates every week.</li>
              		<li>It's not that costly; just support us to improve and manage this awesome plugin.</li>
              	</ul>
              	<a class="btn btn-primary" href="<?php 
                echo  admin_url( 'admin.php?page=apvc-dashboard-page-pricing' ) ;
                ?>">Buy Now</a>
              	<a class="btn btn-danger" id="noReject" href="javascript:void(0)">No, I am very happy with the basic version and I don’t want to use the latest features.</a><br />
              	<span style="font-size: 12px;"><input type="checkbox" id="dnd_show_prom" unchecked>Don't show this popup next time.</span>
              </div>
    ...
    public function apvc_reports_settings_page()
    {
        ...
        ?></small>
					                        ...
					                        <small class="text-muted" style="color: red !important;"><?php 
        echo  __( "If you turned on this, You will not get accurate states on few widgets and filters which are related to ip addresses filters.", "apvc" ) ;
        ?></small>
					                      </div>
					                	</div>
					            	</div>
